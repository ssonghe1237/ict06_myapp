...
<body
	...
	<div class="app-wrapper">
				...
				<ul class="navbar-nav ms-auto">
					...
					<li class="nav-item dropdown"><a class="nav-link"
						...
						<div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
							...
							<a href="#" class="dropdown-item"> <!--begin::Message-->
								<div class="d-flex">
									<div class="flex-shrink-0">
										<img src="${path}/resources/assets/img/user3-128x128.jpg"
											alt="User Avatar" class="img-size-50 rounded-circle me-3" />
									</div>
									<div class="flex-grow-1">
										<h3 class="dropdown-item-title">
					...
					<li class="nav-item dropdown user-menu"><a href="#"
						class="nav-link dropdown-toggle" data-bs-toggle="dropdown"> <img
							...
							class="d-none d-md-inline">${sessionScope.sessionID}</span>
					</a>
		...
		<!-- 컨텐츠 시작 -->
		<div align="center">
			<a href="${path}/admin/inquiry/inquiryDetail.ad">1:1 문의 상세</a><br>	
			<a href="${path}/admin/inquiry/inquiryFaqList.ad">FAQ 분류, 검색</a><br>
			<a href="${path}/admin/inquiry/inquiryFaqList.ad">FAQ 등록</a><br>	
