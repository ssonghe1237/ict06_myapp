...
@Repository
public class AdPlaceDAOImpl implements AdPlaceDAO{
	...
	public List<FestivalDTO> getFestivalList(Map<String, Object> map) {
		...
		return sqlSession.getMapper(AdPlaceDAO.class).getFestivalList(map);
	}
	...
	public int getFestivalCount(Map<String, Object> map) {
		...
		return sqlSession.getMapper(AdPlaceDAO.class).getFestivalCount(map);
	}
